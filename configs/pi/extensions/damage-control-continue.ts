...
// yaml is available as a transitive dependency of pi-coding-agent.
// Use createRequire to resolve it from within pi's package context.
const _piRequire = createRequire(fileURLToPath(import.meta.resolve("@earendil-works/pi-coding-agent")));
const { parse: yamlParse } = _piRequire("yaml");
